...
from pyclad.vision.metrics.pixel_aupro import PixelAUPRO, _compute_pro_fpr_curve, _integrate_pro_curve
...
def test_aupro_batch_does_not_merge_regions_across_images():
    ...
    # PRO=0.5 only appears if regions are labeled per-image (one region detected, one missed).
