...
def concept_incremental_scenario(
    data_loader: ConceptsDataset, strategy: ConceptIncrementalStrategy, callbacks: List[Callback]
):
    ...
    for train_concept in data_loader.train_concepts():
        ...
        strategy.learn(data=train_concept.data)
