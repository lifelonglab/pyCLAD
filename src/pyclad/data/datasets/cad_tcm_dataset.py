...
class CadTcmDataset(TabularCadDataset):
    """
    CAD-TCM benchmark (8 concepts). See :class:`TabularCadDataset` for details and the ``ordering`` parameter.
    ...
    _hf_repo = "lifelonglab/CAD-TCM"
    _display_name = "CAD-TCM"
