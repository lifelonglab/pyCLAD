...
from pyclad.data.vision._utils import find_duplicates, infer_category_order_from_samples
from pyclad.data.vision.benchmarks.ordering import (
...
DEFAULT_VISION_BENCHMARK_MANIFESTS_DIR = (
    Path(__file__).resolve().parents[2] / "datasets" / "vision_datasets" / "manifests"
)
DEFAULT_VISION_BENCHMARK_ORDERINGS_DIR = Path(__file__).resolve().parents[5] / "examples" / "vision_models" / "ordering"
